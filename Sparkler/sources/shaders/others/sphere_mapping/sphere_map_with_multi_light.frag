...
vec3 calculateDirectionalLight(DirectionalLight light, vec3 normal, vec3 viewDirection)
{
	...
	vec3 diffuse = light.diffuse * diffuseCoeff * texture(material.textureDiffuse1, texCoords).rgb;
	...
	vec3 specular = light.specular * specularCoeff * texture(material.textureSpecular1, texCoords).rgb;
...
vec3 calculateSpotLight(SpotLight light, vec3 normal, vec3 viewDirection)
{
	...
	vec3 textureSpecular1 = texture(material.textureSpecular1, texCoords).rgb;
	vec3 specular = light.specular * specularCoeff * textureSpecular1;
...
void main()
{
	...
	// debug
//	irradiance += texture(material.textureSpecular1, texCoords).rgb;
